...
(function() {
  ...
  twttr.txt.regexen.validUrlQueryEndingChars = /[a-z0-9-_&=#\/]/i;
  ...
  twttr.txt.getTweetLength = function(text, options) {
    if (!options) {
      options = {
          ...
          short_url_length_https: 23 // all t.co links are now https
      };
    }
